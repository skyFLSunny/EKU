...
- (void)loadView
{
    ...
    self.view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, 250)];
...
#ifdef DEBUG
    _messageLabel = [[UILabel alloc] initWithFrame:CGRectMake(20,20,width-40,30)];
    _messageLabel.backgroundColor = [UIColor clearColor];
    _messageLabel.textColor = [UIColor blackColor];
_messageLabel.hidden = NO;
    _messageLabel.font = [UIFont systemFontOfSize:14];
    _messageLabel.text = @"不等式";
 ...
 [_topHUD addSubview:_messageLabel];
    ...
    _doneButton.frame = CGRectMake(0, 5, 50, topH);
...
- (void) doneDidTouch: (id) sender
{
    ...
    UINavigationController*curcon= tab.selectedViewController;
        [curcon popViewControllerAnimated:YES];
}
...
- (void) updateBottomBar
{
    ...
    [_bottomBar setItems:@[_fixedSpaceItem,  playPauseBtn,
                          ] animated:NO];
}
