...
TYHScrollView* goBackgroundView;
...
- (void)showImage:(UIImageView *)defaultImageView{
    ...
    goBackgroundView = [[TYHScrollView alloc]initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height)];
...
//        defaultImageView.alpha = 0;
        [UIView animateWithDuration:_duration animations:^{
            ...
            //这里是改变 背景色的透明度 的哦哦哦   哈哈 
            goBackgroundView.backgroundColor=[UIColor colorWithRed:0 green:0 blue:0 alpha:0.9];
...
- (void)hideImage:(UITapGestureRecognizer*)tap{
     ...
     [goBackgroundView imageViewRecover];
    [self performSelector:@selector(hide:) withObject:tap afterDelay:0.3f];
